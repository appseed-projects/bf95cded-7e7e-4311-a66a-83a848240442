...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-30 10:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bf95cded-7e7e-4311-a66a-83a848240442.git
$ cd bf95cded-7e7e-4311-a66a-83a848240442
```
